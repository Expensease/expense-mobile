...
import {TPayment, TPaymentContext} from '../types';
...
export const PaymentContext = createContext<TPaymentContext>(undefined);

export const PaymentContextWrapper = ({children}: PropsWithChildren) => {
